...
class Card extends Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get(
        `${import.meta.env.VITE_BACKEND_URL}/api/users/fb/${
    ...
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/users/${this.state.user}`)
      .then(res => {
    ...
    axios
      .get(`${import.meta.env.VITE_BACKEND_URL}/api/countries/${index}`)
      .then(res => {
    ...
    axios
      ...
      .then(res => {
        ...
        if (country.length === 0) {
          axios
            .post(
              `${import.meta.env.VITE_BACKEND_URL}/api/mapview`,
              countryData
            )
            .then(res => {
